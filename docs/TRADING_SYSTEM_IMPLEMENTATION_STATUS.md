...
| 4 Sector analysis | P0 | Started | theme strength ranking and summary | Add theme registry and leader extraction |
...
| 3 | Add theme registry and leader extraction | Makes sector analysis configurable |
